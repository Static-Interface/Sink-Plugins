...
public class TownyHelper {
    ...
    public static String getNationTag(Player player) {
        ...
        return ScSettings.SC_PREFIX_NATION.format(ChatColor.stripColor(nation.getTag())) + ' ' + ChatColor.RESET;
    }
    ...
    public static String getNation(Player player) {
        ...
        return ScSettings.SC_PREFIX_NATION.format(ChatColor.stripColor(nation.getName())) + ' ' + ChatColor.RESET;
    }
    ...
    public static String getTownTag(Player player) {
        ...
        return ScSettings.SC_PREFIX_TOWN.format(ChatColor.stripColor(town.getTag())) + ' ' + ChatColor.RESET;
    }
    ...
    public static String getTown(Player player) {
        ...
        return ScSettings.SC_PREFIX_TOWN.format(ChatColor.stripColor(town.getName())) + ' ' + ChatColor.RESET;
    }
}
