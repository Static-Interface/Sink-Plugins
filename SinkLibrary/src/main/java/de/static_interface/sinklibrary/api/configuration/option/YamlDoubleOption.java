...
public class YamlDoubleOption extends YamlOption<Double> {

    public YamlDoubleOption(String path, Double defaultValue) {
        super(path, defaultValue);
    }

    public YamlDoubleOption(String path, Double defaultValue, String comment) {
    ...
    public Double getValue() {
        return getConfig().getYamlConfiguration().getDouble(getPath(), getDefaultValue());
    }
}
