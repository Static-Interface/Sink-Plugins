...
public class YamlColorOption extends YamlOption<Color> {

    public YamlColorOption(String path, Color defaultValue) {
        super(path, defaultValue);
    }

    public YamlColorOption(String path, Color defaultValue, String comment) {
    ...
    public Color getValue() {
        return getConfig().getYamlConfiguration().getColor(getPath(), getDefaultValue());
    }
}
