...
public class YamlVectorOption extends YamlOption<Vector> {

    public YamlVectorOption(String path, Vector defaultValue) {
        super(path, defaultValue);
    }

    public YamlVectorOption(String path, Vector defaultValue, String comment) {
    ...
    public Vector getValue() {
        return getConfig().getYamlConfiguration().getVector(getPath(), getDefaultValue());
    }
}
